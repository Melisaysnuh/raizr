...
def to_railroad(element: pyparsing.ParserElement, diagram_kwargs: typing.Optional[dict] = ..., vertical: int = ..., show_results_names: bool = ..., show_groups: bool = ..., show_hidden: bool = ...) -> list[NamedDiagram]:
    """
...
class ConverterState:
    ...
    def get(self, key, default=...): # -> ElementState | None:
        ...
