...
class KernelProvisionerBase(ABC, LoggingConfigurable, metaclass=KernelProvisionerMeta):
    ...
    @abstractmethod
    async def terminate(self, restart: bool = ...) -> None:
        """
    ...
    @abstractmethod
    async def cleanup(self, restart: bool = ...) -> None:
        """
    ...
    async def shutdown_requested(self, restart: bool = ...) -> None:
        """
    ...
    def get_shutdown_wait_time(self, recommended: float = ...) -> float:
        """
    ...
    def get_stable_start_time(self, recommended: float = ...) -> float:
        """
